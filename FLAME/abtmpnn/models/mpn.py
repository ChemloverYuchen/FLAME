...
from FLAME.dataprocess.abtmpnn.features import BatchMolGraph, get_atom_fdim, get_bond_fdim, mol2graph
...
class MPNEncoder(nn.Module):
    ...
    def __init__(self, args: TrainArgs, atom_fdim: int, bond_fdim: int):
        """
        :param args: A :class:`~abtmpnn.args.TrainArgs` object containing model arguments.
    ...
    def forward(self,
        ...
        :param mol_graph: A :class:`~abtmpnn.features.featurization.BatchMolGraph` representing
...
class MPN(nn.Module):
    ...
    def forward(self,
        ...
        :param batch: A list of list of SMILES, a list of list of RDKit molecules, or a
                      list of :class:`~abtmpnn.features.featurization.BatchMolGraph`.
