...
from FLAME.abtmpnn.args import PredictArgs, TrainArgs
from FLAME.dataprocess.abtmpnn.data import StandardScaler, MoleculeDataset, preprocess_smiles_columns, get_task_names
from FLAME.abtmpnn.models import MoleculeModel
...
def save_checkpoint(path: str,
    ...
    :param model: A :class:`~abtmpnn.models.model.MoleculeModel`.
    :param scaler: A :class:`~abtmpnn.data.scaler.StandardScaler` fitted on the data.
    :param features_scaler: A :class:`~abtmpnn.data.scaler.StandardScaler` fitted on the features.
    :param atom_descriptor_scaler: A :class:`~abtmpnn.data.scaler.StandardScaler` fitted on the atom descriptors.
    :param bond_feature_scaler: A :class:`~abtmpnn.data.scaler.StandardScaler` fitted on the bond_fetaures.
    :param args: The :class:`~abtmpnn.args.TrainArgs` object containing the arguments the model was trained with.
...
def load_checkpoint(path: str,
    ...
    :return: The loaded :class:`~abtmpnn.models.model.MoleculeModel`.
    """
...
def build_optimizer(model: nn.Module, args: TrainArgs) -> Optimizer:
    ...
    :param args: A :class:`~abtmpnn.args.TrainArgs` object containing optimizer arguments.
...
def build_lr_scheduler(optimizer: Optimizer, args: TrainArgs, total_epochs: List[int] = None) -> _LRScheduler:
    ...
    :param args: A :class:`~abtmpnn.args.TrainArgs` object containing learning rate arguments.
...
def save_smiles_splits(data_path: str,
    ...
    :param train_data: Train :class:`~abtmpnn.data.data.MoleculeDataset`.
    :param val_data: Validation :class:`~abtmpnn.data.data.MoleculeDataset`.
    :param test_data: Test :class:`~abtmpnn.data.data.MoleculeDataset`.
...
def update_prediction_args(predict_args: PredictArgs,
    ...
    :param predict_args: The :class:`~abtmpnn.args.PredictArgs` object containing the arguments to use for making predictions.
    :param train_args: The :class:`~abtmpnn.args.TrainArgs` object containing the arguments used to train the model previously.
    :param missing_to_defaults: Whether to replace missing training arguments with the current defaults for :class: `~abtmpnn.args.TrainArgs`.
