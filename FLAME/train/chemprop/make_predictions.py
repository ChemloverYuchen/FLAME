...
from FLAME.chemprop.args import PredictArgs, TrainArgs
from FLAME.dataprocess.chemprop.data import get_data, get_data_from_smiles, MoleculeDataLoader, MoleculeDataset, StandardScaler, AtomBondScaler
from FLAME.chemprop.utils import load_args, load_checkpoint, load_scalers, makedirs, timeit, update_prediction_args
from FLAME.dataprocess.chemprop.features import set_extra_atom_fdim, set_extra_bond_fdim, set_reaction, set_explicit_h, set_adding_hs, set_keeping_atom_map, reset_featurization_parameters
from FLAME.chemprop.models import MoleculeModel
from FLAME.chemprop.uncertainty import UncertaintyCalibrator, build_uncertainty_calibrator, UncertaintyEstimator, build_uncertainty_evaluator
from FLAME.chemprop.multitask_utils import reshape_values
...
def uvvisml_predict(model_path, output_file, input_file='', smiles=None) -> None:
    """Parses Chemprop predicting arguments and runs prediction using a trained Chemprop model.

    This is the entry point for the command line command :code:`abtmpnn_predict`.
    """
