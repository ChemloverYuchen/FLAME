...
from FLAME.abtmpnn.utils import load_args, load_checkpoint, makedirs, timeit, load_scalers, update_prediction_args
...
def model_fingerprint(model: MoleculeModel,
    ...
    :param data_loader: A :class:`~abtmpnn.data.data.MoleculeDataLoader`.
