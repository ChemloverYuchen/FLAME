...
from FLAME.dataprocess.abtmpnn.data import get_data, get_data_from_smiles, MoleculeDataLoader, MoleculeDataset
from FLAME.abtmpnn.utils import load_args, load_checkpoint, load_scalers, makedirs, timeit, update_prediction_args
...
def make_predictions(args: PredictArgs, smiles: List[List[str]] = None) -> List[List[Optional[float]]]:
    ...
    :param args: A :class:`~abtmpnn.args.PredictArgs` object containing arguments for
...
# def abtmpnn_predict(data_base, model, target) -> None:
def abtmpnn_predict(model_path, output_file, input_file='', smiles=None) -> None:
