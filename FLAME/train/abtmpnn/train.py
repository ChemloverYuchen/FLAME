...
from FLAME.dataprocess.abtmpnn.data import MoleculeDataLoader, MoleculeDataset
...
def train(model: MoleculeModel,
    ...
    :param args: A :class:`~abtmpnn.args.TrainArgs` object containing arguments for training the model.
