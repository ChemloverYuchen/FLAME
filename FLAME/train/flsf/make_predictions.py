...
from FLAME.dataprocess.flsf.data import get_data, get_data_from_smiles, MoleculeDataLoader, MoleculeDataset
...
#     print(f'Predicting with an ensemble of {len(args.checkpoint_paths)} models')
    ...
    for full_index, datapoint in enumerate(full_data):
        ...
        if args.drop_extra_columns:
            ...
            for column, smi in zip(smiles_columns, datapoint.smiles):
                datapoint.row[column] = smi
...
def flsf_predict(model_path, output_file='', input_file='', smiles=[]) -> None:
