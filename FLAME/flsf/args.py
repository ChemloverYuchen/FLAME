...
from FLAME.dataprocess.flsf.data import set_cache_mol, preprocess_smiles_columns
from FLAME.dataprocess.flsf.features import get_available_features_generators
...
class CommonArgs(Tap):
    ...
    def features_scaling(self) -> bool:
        """
        Whether to apply normalization with a :class:`~flsf.data.scaler.StandardScaler`
...
class TrainArgs(CommonArgs):
    ...
    gru_layers: int =2
    """Number of layers in the GRU model"""
